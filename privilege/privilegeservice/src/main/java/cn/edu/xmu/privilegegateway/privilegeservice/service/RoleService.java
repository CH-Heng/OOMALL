...
public class RoleService {
    ...
    public ReturnObject selectRole(Long id) {
        ReturnObject retObj = roleDao.selectRole(id);
    ...
    public ReturnObject forbidRole(Role bo) {
        return roleDao.updateRoleState(bo);
    }
    ...
    {
        ReturnObject ret=roleDao.isBaseRole(roleid);
        if(ret.getCode()==ReturnNo.OK&&(Boolean)ret.getData()) {
    ...
    public ReturnObject<Object> delBaseRolePriv(Long rid,Long pid){
        ReturnObject ret=roleDao.isBaseRole(rid);
        if(ret.getCode()==ReturnNo.OK&&(Boolean)ret.getData()) {
