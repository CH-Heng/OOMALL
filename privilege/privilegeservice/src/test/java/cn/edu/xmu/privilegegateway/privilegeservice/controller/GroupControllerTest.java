...
class GroupControllerTest {
    ...
    private static String testToken = jwtHelper.createToken(47L, "user", 1L, 1, 3600);
    ...
    public void getallGroupsuser() throws Exception {
        ...
        String responseString = this.mvc.perform(get("/departs/0/groups/4/users").contentType("application/json;charset=UTF-8").header("authorization", adminToken))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString = "{\"errno\":0,\"errmsg\":\"成功\"}";
    ...
    public void addgroup_wrongdid1() throws Exception{
        ...
        String requestJson = "{\"name\": \"测试1\"}";
        String responseString = this.mvc.perform(post("/departs/2/groups").contentType("application/json;charset=UTF-8").header("authorization", testToken).content(requestJson))
    ...
    public void deletegroup_wrongdid() throws Exception{
        String responseString = this.mvc.perform(delete("/departs/0/groups/2").contentType("application/json;charset=UTF-8").header("authorization", testToken))
                .andExpect(status().is4xxClientError())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString = "{\"errno\":505,\"errmsg\":\"操作的资源id不是自己的对象\"}";
    ...
    public void forbidgroup() throws Exception{
        ...
        String responseString = this.mvc.perform(put("/departs/0/groups/1/forbid").contentType("application/json;charset=UTF-8").header("authorization", adminToken))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString = "{\"errno\":0,\"errmsg\":\"成功\"}";
    ...
    public void didwrongforbidgroup() throws Exception{
        String responseString = this.mvc.perform(put("/departs/1/groups/1/forbid").contentType("application/json;charset=UTF-8").header("authorization", adminToken))
                .andExpect(status().is4xxClientError())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString = "{\"errno\":505,\"errmsg\":\"操作的资源id不是自己的对象\"}";
    ...
    @Test
    @Transactional
    public void getgroupsbaseroles() throws Exception {
        String responseString = this.mvc.perform(get("/departs/1/groups/8/baseroles").contentType("application/json;charset=UTF-8").header("authorization", adminToken))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString = "{\"errno\":0,\"errmsg\":\"成功\"}";
    ...
    public void getgroupsroles() throws Exception {
        String responseString = this.mvc.perform(get("/departs/1/groups/8/roles").contentType("application/json;charset=UTF-8").header("authorization", adminToken))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString = "{\"errno\":0,\"errmsg\":\"成功\"}";
    ...
    @Test
    @Transactional
    public void getselfgroups() throws Exception {
        String responseString = this.mvc.perform(get("/self/groups").contentType("application/json;charset=UTF-8").header("authorization", adminToken))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString = "{\"errno\":0,\"errmsg\":\"成功\"}";
