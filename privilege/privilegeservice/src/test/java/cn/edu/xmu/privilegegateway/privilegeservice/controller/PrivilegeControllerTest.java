...
public class PrivilegeControllerTest {
    ...
    public void testSetUsersProxy() throws Exception {
        ...
        String responseString1 = mvc.perform(post("/users/17333/proxies").header("authorization", token17334)
                ...
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString1 = "{\"errno\":0,\"data\":{\"user\":{\"id\":17333,\"name\":null},\"proxyUser\":{\"id\":17334,\"name\":null}},\"errmsg\":\"成功\"}";
        ...
        String responseString5 = mvc.perform(post("/users/57/proxies").header("authorization", token17334)
                ...
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString5 = "{\"errno\":505,\"errmsg\":\"操作的资源id不是自己的对象\"}";
    ...
    public void testSetUsersProxyByAdmin() throws Exception {
        ...
        String responseString1 = mvc.perform(post("/departs/1/users/17333/proxyusers/17334").header("authorization", token17334)
                ...
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString1 = "{\"errno\":0,\"data\":{\"user\":{\"id\":17333,\"name\":null},\"proxyUser\":{\"id\":17334,\"name\":null},\"valid\":1},\"errmsg\":\"成功\"}";
        JSONAssert.assertEquals(expectString1, responseString1, false);
        //开始时间早于结束时间
        String contentJson2 = "{\"beginDate\": \"2020-05-03T18:54:29.000+08:00\",\"endDate\": \"2020-05-02T18:54:29.000+08:00\"}";
        ...
        String responseString3 = mvc.perform(post("/departs/0/users/17333/proxyusers/17334").header("authorization", token17334)
                ...
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString3 = "{\"errno\":747,\"errmsg\":\"同一时间段有冲突的代理关系\"}";
    ...
    public void testGetProxies() throws Exception {
        String responseString1 = mvc.perform(get("/departs/2/proxies?beginTime=1900-11-11T10:10:10.000+08:00&endTime=2050-11-11T16:10:10.000+08:00").header("authorization", token17334)
                ...
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString1 = "{\"errno\":0,\"data\":{\"total\":1,\"pages\":1,\"pageSize\":10,\"page\":1,\"list\":[{\"id\":7,\"user\":{\"id\":17334,\"name\":null},\"proxyUser\":{\"id\":17333,\"name\":null},\"valid\":1,\"creator\":{\"id\":1,\"name\":\"admin\"},\"modifier\":{\"id\":null,\"name\":null},\"sign\":0}]},\"errmsg\":\"成功\"}";
        JSONAssert.assertEquals(expectString1, responseString1, false);
    ...
    public void getUserStates() throws Exception {
        String responseString = mvc.perform(get("/users/states").header("authorization", pToken)
                ...
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString = "{\"errno\":0,\"data\":[{\"code\":0,\"name\":\"新注册\"},{\"code\":1,\"name\":\"正常\"},{\"code\":2,\"name\":\"封禁\"},{\"code\":3,\"name\":\"废弃\"}],\"errmsg\":\"成功\"}";
        JSONAssert.assertEquals(expectString, responseString, false);
    }
    ...
    public void checkSelfInformation() throws Exception {
        ...
        String responseString = mvc.perform(get("/self/users").header("authorization", pToken)
                ...
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString = "{\"errno\":0,\"data\":{\"id\":60,\"userName\":\"pikaas\",\"name\":\"刘冰帅\",\"mobile\":\"123456789\",\"email\":\"123456789@qq.com\",\"avatar\":null,\"lastLoginTime\":null,\"lastLoginIp\":null,\"state\":1,\"departId\":0,\"idNumber\":\"123456789123\",\"passportNumber\":\"123456\",\"creator\":null,\"modifier\":null,\"sign\":0},\"errmsg\":\"成功\"}";
        JSONAssert.assertEquals(expectString, responseString, false);
    }
...
/*    @Test
    ...
    public void getUserInformation() throws Exception {
        ...
        String responseString = mvc.perform(get("/departs/0/users").header("authorization", pToken)
                ...
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString = "{\"errno\":0,\"data\":{\"total\":1,\"pages\":1,\"pageSize\":1,\"page\":1,\"list\":[{\"id\":60,\"userName\":\"pikaas\",\"name\":\"刘冰帅\",\"mobile\":\"123456789\",\"email\":\"123456789@qq.com\",\"avatar\":null,\"lastLoginTime\":null,\"lastLoginIp\":null,\"state\":1,\"departId\":0,\"idNumber\":\"123456789123\",\"passportNumber\":\"123456\",\"creator\":null,\"modifier\":null,\"sign\":0}]},\"errmsg\":\"成功\"}";
        JSONAssert.assertEquals(expectString, responseString, false);
    }
    ...
    public void getNewUserInformation() throws Exception {
        String responseString = mvc.perform(get("/departs/0/users/new").header("authorization", pToken)
                ...
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString = "{\"errno\":0,\"data\":{\"total\":1,\"pages\":1,\"pageSize\":1,\"page\":1,\"list\":[{\"id\":4,\"name\":\"刘冰帅\"}]},\"errmsg\":\"成功\"}";
        JSONAssert.assertEquals(expectString, responseString, false);
    }
    ...
    public void getAnyUserInformation() throws Exception {
        ...
        String responseString = mvc.perform(get("/departs/0/users/60").header("authorization", pToken)
                ...
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString = "{\"errno\":0,\"data\":{\"id\":60,\"userName\":\"pikaas\",\"name\":\"刘冰帅\",\"mobile\":\"123456789\",\"email\":\"123456789@qq.com\",\"avatar\":null,\"state\":1,\"departId\":0,\"idNumber\":\"123456789123\",\"passportNumber\":\"123456\",\"creator\":null,\"modifier\":null,\"sign\":0},\"errmsg\":\"成功\"}";
        JSONAssert.assertEquals(expectString, responseString, false);
    }
    ...
    void getBaserolesByRoleId() throws Exception {
        ...
        String responseString = this.mvc.perform(get("/departs/0/roles/1/baseroles?pageSize=1")
                ...
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString = "{\"errno\":0,\"data\":{\"pageSize\":1,\"page\":1,\"list\":[{\"id\":88,\"name\":\"预售管理\",\"descr\":\"预售活动的管理\",\"departId\":0,\"creator\":{\"id\":1,\"name\":\"admin\"},\"modifier\":{\"id\":null,\"name\":null},\"sign\":null}]},\"errmsg\":\"成功\"}";
        JSONAssert.assertEquals(expectString, responseString, false);
    }
    ...
    public void selectAllRoles() throws Exception {
        String responseString = this.mvc.perform(get("/departs/1/roles?pageSize=1")
                ...
                .andReturn().getResponse().getContentAsString();
        String expectString;
        expectString = "{\"errno\":0,\"data\":{\"total\":8,\"pages\":8,\"pageSize\":1,\"page\":1,\"list\":[{\"id\":2,\"name\":\"店铺1超级管理员\",\"descr\":null,\"departId\":1,\"creator\":{\"id\":1,\"name\":\"admin\"},\"modifier\":{\"id\":null,\"name\":null},\"sign\":null}]},\"errmsg\":\"成功\"}";
        JSONAssert.assertEquals(expectString, responseString, false);
    }
    ...
    public void selectSelfRoles() throws Exception {
        String responseString = this.mvc.perform(get("/self/roles")
                ...
                .andReturn().getResponse().getContentAsString();
        String expectString;
        expectString = "{\"errno\":0,\"data\":{\"total\":1,\"pages\":1,\"pageSize\":1,\"page\":1,\"list\":[{\"id\":3,\"name\":\"店铺2超级管理员\",\"descr\":null,\"departId\":2,\"creator\":{\"id\":1,\"name\":\"admin\"},\"modifier\":{\"id\":null,\"name\":null},\"sign\":0}]},\"errmsg\":\"成功\"}";
        JSONAssert.assertEquals(expectString, responseString, false);
    }
    ...
    public void testModifyPassword() throws Exception {
        String contentJson1="{\n" +
                ...
                "  \"newPassword\": \"123456\"\n" +
                "}";
        Mockito.when(redisUtil.get("cp_123456")).thenReturn(62);
        ...
        responseString1 = mvc.perform(put("/self/password")
                ...
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        expectString1 = "{\"errno\":701,\"errmsg\":\"登录用户id不存在\"}";
        JSONAssert.assertEquals(expectString1, responseString1, true);
    }
    @Test
   ...
   /**
    ...
    public void testLogout() throws Exception{
        ...
        String responseString1 = this.mvc.perform(MockMvcRequestBuilders.get("/logout")
                ...
                .andExpect(MockMvcResultMatchers.content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString(StandardCharsets.UTF_8);
        String expectedString1 = "{\"errno\":704,\"errmsg\":\"需要先登录\"}";
        JSONAssert.assertEquals(expectedString1,responseString1,false);
    }
    ...
    public void selectRoleTest() throws Exception {
        String responseString = this.mvc.perform(get("/departs/1/roles/2")
                .header("authorization", adminToken)
                .contentType("application/json;charset=UTF-8"))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString;
        expectString="{\"errno\":0,\"data\":{\"id\":2,\"name\":\"店铺1超级管理员\",\"descr\":null,\"departId\":1,\"creator\":{\"id\":1,\"name\":\"admin\"},\"modifier\":{\"id\":null,\"name\":null},\"sign\":null},\"errmsg\":\"成功\"}";
        JSONAssert.assertEquals(expectString, responseString, false);
    }
    ...
    @Test
    @Transactional
    public void selectBaseRolesTest() throws Exception {
        String responseString = this.mvc.perform(get("/departs/0/baseroles?pageSize=1")
                .header("authorization", adminToken)
                .contentType("application/json;charset=UTF-8"))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectString;
        expectString = "{\"errno\":0,\"data\":{\"pageSize\":1,\"page\":1,\"list\":[{\"id\":88,\"name\":\"预售管理\",\"descr\":\"预售活动的管理\",\"departId\":0,\"creator\":{\"id\":1,\"name\":\"admin\"},\"modifier\":{\"id\":null,\"name\":null},\"sign\":null}]},\"errmsg\":\"成功\"}";
        JSONAssert.assertEquals(expectString, responseString, false);
    }
}
