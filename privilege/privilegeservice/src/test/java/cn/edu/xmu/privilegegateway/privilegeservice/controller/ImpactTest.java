...
public class ImpactTest {
    ...
    public void privilegeImpactTest() throws JSONException {
        ...
        String except="[up_47, up_46, fu_55, up_49, up_48, u_51, u_52, u_50, fu_50, r_106, r_107, up_50, r_89, u_55, fu_53, fu_52, u_53, fu_51, fu_47, fu_46, up_55, r_2, up_52, r_1, up_51, u_1, r_4, fu_49, r_3, fu_48, up_53, r_6, r_5, r_8, r_7, r_9, fu_1, u_48, r_11, u_49, u_46, up_1, u_47]";
    ...
    public void roleImp() throws JSONException {
        ...
        list.add(String.format(ROLEKEY,5L));
        list.add(String.format(ROLEKEY,23L));
        String except="[up_47, u_17332, up_46, u_17335, u_17337, up_49, up_48, u_51, u_52, u_50, up_50, u_55, u_53, fu_47, fu_46, r_2, fu_17332, r_1, fu_17335, r_4, fu_49, r_3, fu_48, r_6, r_5, r_8, r_7, r_9, r_91, u_48, r_11, u_49, u_46, up_1, u_47, fu_55, up_17332, up_17335, fu_50, r_106, r_107, fu_53, fu_52, g_6, fu_51, g_8, up_55, up_52, up_51, u_1, up_53, fu_1]";
    ...
    public void deleteUserRedis() throws Exception{
        ...
        userExpectResults.add(String.format(USERPROXYKEY,17332L));
        userExpectResults.add(String.format(FINALUSERKEY,17332));
        userExpectResults.add(String.format(USERKEY,17332));
        userExpectResults.add(String.format(FINALUSERKEY,17332));
        userExpectResults.add(String.format(USERPROXYKEY,17332));
    ...
    public void deleteGroupRelationRedis() throws Exception{
        ...
        userExpectResults.add(String.format(USERPROXYKEY,17332));
        userExpectResults.add(String.format(USERPROXYKEY,17332));
        userExpectResults.add(String.format(USERPROXYKEY,17335));
        userExpectResults.add(String.format(FINALUSERKEY,17332));
        userExpectResults.add(String.format(FINALUSERKEY,17332));
        userExpectResults.add(String.format(FINALUSERKEY,17335));
        JSONAssert.assertEquals(userExpectResults.toString(), userResults.toString(),false);
    }
}