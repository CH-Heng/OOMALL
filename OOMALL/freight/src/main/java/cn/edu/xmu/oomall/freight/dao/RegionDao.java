...
import cn.edu.xmu.oomall.freight.model.vo.RegionDetailRetVo;
...
public class RegionDao {
    ...
    public ReturnObject getRegionById(Long id){
        try {
            RegionPo po = regionPoMapper.selectByPrimaryKey(id);
            if(po==null){
                return new ReturnObject(ReturnNo.RESOURCE_ID_NOTEXIST);
            }
            return new ReturnObject(cloneVo(po, SimpleRegionRetVo.class));

        }catch (Exception e){
            return new ReturnObject(ReturnNo.INTERNAL_SERVER_ERR, e.getMessage());
        }
    }
    public ReturnObject getRegionDetailById(Long id){
        try {
            RegionPo po = regionPoMapper.selectByPrimaryKey(id);
            if(po==null){
                return new ReturnObject(ReturnNo.RESOURCE_ID_NOTEXIST);
            }
            return new ReturnObject(cloneVo(po, RegionDetailRetVo.class));
